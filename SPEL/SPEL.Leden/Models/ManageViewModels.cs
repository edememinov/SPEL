...
namespace SPEL.Leden.Models
{
    ...
    public class ChangeAdresViewModel
    {
        [Required]
        [StringLength(100, ErrorMessage = "The {0} must be at least {2} characters long.",MinimumLength = 6)]
        [Display(Name = "Niewe Adres")]
        public string NewAdres { get; set; }

        [Required]
        [StringLength(6, ErrorMessage = "The {0} must be at least {2} characters long.", MinimumLength = 6)]
        [Display(Name = "Niewe Postcode")]
        public string NewPostcode { get; set; }

        [Required]
        [StringLength(100, ErrorMessage = "The {0} must be at least {2} characters long.", MinimumLength = 6)]
        [Display(Name = "Niewe Woonplaats")]
        public string NewWoonplaats { get; set; }

    }

    public class ChangePasfotoViewModel
    {
        [Required]
        [Phone]
